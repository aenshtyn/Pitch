...
def setUp(self):
        ...
        self.new_comment = Comment(pitch_id=12345,pitch_title='Comment for pitches',image_path="https://image.tmdb.org/t/p/w500/jdjdjdjn",pitch_comment='This pitch is the best thing since sliced bread',user = self.user_James )
...
def test_check_instance_variables(self):
        ...
        self.assertEquals(self.new_comment.pitch_title,'Comment for pitchs')
